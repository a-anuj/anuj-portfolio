...
import './App.css'
import avatar from './assets/anuj_amazon-removebg-preview.png'
...
function App() {
  ...
  const skills = [
    ...
    },
    {
      ...
      items: ['AWS', 'Amazon EC2', 'Amazon S3'],
    },
    {
      ...
      <section className="section fade-in" id="achievements">
        ...
        <div className="achievements-list">
          <div className="achievement-item">
            ...
            <p>Ranked in the <strong>top 75 coders</strong> at <strong>HackOn with Amazon 6.0</strong>.</p>
          </div>
          <div className="achievement-item">
            <span className="achievement-icon"></span>
          ...
          <div className="education-card">
            <div className="experience-header">
              ...
              <div style={{ textAlign: 'right' }}>
                ...
                <p className="education-score">GPA: 8.7/10</p>
              </div>
            </div>
          </div>
          <div className="education-card">
